...
export function createView() {
    return `
        <h1>Very simple version</h1>
        <iframe
        src="../clickers/verySimple.html" name="simple"
        height="300px"
        width="500px"
...
<span style="color: #007700">&lt;body</span> <span style="color: #0000CC">style=</span><span style="background-color: #fff0f0">&quot;text-align: center;&quot;</span><span style="color: #007700">&gt;</span>
    ...
    \t<span style="color: #008800; font-weight: bold">let</span> count <span style="color: #333333">=</span> <span style="color: #0000DD; font-weight: bold">0</span>;       
        ...
        <span style="color: #008800; font-weight: bold">function</span> addToCount() {        \t
            <span style="color: #007020">document</span>.getElementById(<span style="background-color: #fff0f0">&quot;display&quot;</span>).innerHTML <span style="color: #333333">=</span> count<span style="color: #333333">++</span>;
        }
